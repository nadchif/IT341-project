...
<body>
  <div class="container">
    ...
    <div class="well">
      <form action="pbaptism.php?b_id=<?php echo $id;?>" class="form-horizontal well span9" method="post">
        <fieldset>
          ...
          <div class="form-group">
            <div class="col-md-4">
              ...
              <div class="col-lg-8">
                ...
                readonly="true" type="text" value="<?php echo $res->bapt_id;?>">
              </div>
            </div>
          </div>
            ...
            <div class="rows">
              ...
              <div class="col-md-4">
                ...
                <div class="col-lg-8">
                  ...
                  "text" value="<?php echo $res->bkPage;?>">
                </div>
              </div>
              ...
              <div class="col-md-4">
                ...
                <div class="col-lg-8">
                  ...
                  "text" value="<?php echo $res->bkLine;?>">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="rows">
              ...
              <div class="col-md-4">
                ...
                <div class="col-lg-8">
                  ...
                  type="text" value="<?php echo $res->minister;?>">
                </div>
              </div>
              ...
              <div class="col-md-4">
                ...
                <div class="col-lg-8">
                  ...
                  "text" value="<?php echo $res->stipend;?>">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="rows">
              <div class="col-md-6">
                ...
                <div class="col-lg-8">
                  ...
                  rows="3" value="<?php echo $res->remarks;?>">
</textarea>
                </div>
              </div>
              ...
              <div class="col-md-6">
                 <label for="cur_date" class="col-lg-7 control-label">Date of Baptism:</label>
                    ...
                    <div class="input-group date form_curdate col-md-5" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                    <input class="form-control" size="11" type="text" value="<?php echo $res->cur_date;?>" readonly name="cur_date" id="cur_date">
            ...
            <div class="rows">
              <div class="col-md-5">
                ...
                <div class="col-lg-8">
                  ...
                  readonly="true" type="text" value="<?php echo $res->pers_id;?>">
                </div>
              </div>
              ...
              <div class="col-md-5">
				<label for="birth_date" class="col-lg-4 control-label">Birth Date:</label>
                    ...
                    <input class="form-control" size="11" type="text" value="<?php echo $res->birth_date;?>" readonly name="birth_date" id="birth_date">
                    <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
					<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                </div>
				<!--<input type="hidden" id="dtp_input2" value="" /><br/>-->
          ...
          <div class="form-group">
            <div class="rows">
              <div class="col-md-5">
                ...
                <div class="col-lg-8">
                  <input class="form-control" id="age" name="age" type="text" value="<?php echo $res->age;?>">
                </div>
              </div>
              ...
              <div class="col-md-5">
                ...
                <div class="col-lg-8">
                  ...
                  "birth_place" type="text" value="<?php echo $res->birth_place;?>">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="rows">
              <div class="col-md-5">
                ...
                <div class="col-lg-8">
                  ...
                  "text" value="<?php echo $res->father;?>">
                </div>
              </div>
              ...
              <div class="col-md-5">
                ...
                <div class="col-lg-8">
                  ...
                  type="text" value="<?php echo $res->f_Origin;?>">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="rows">
              <div class="col-md-5">
                ...
                <div class="col-lg-8">
                  ...
                  "text" value="<?php echo $res->Mother;?>">
                </div>
              </div>
              ...
              <div class="col-md-5">
                ...
                <div class="col-lg-8">
                  ...
                  type="text" value="<?php echo $res->m_Origin;?>">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="rows">
              <div class="col-md-5">
                ...
                <div class="col-lg-8">
                  ...
                  type="text" value="<?php echo $res->legitimacy;?>">
                </div>
              </div>
            </div>
          </div>
        ...
        <fieldset>
          ...
          <div class="form-group">
            <div class="col-md-5">
              ...
              <div class="col-lg-8">
                ...
                readonly="true" type="text" value="<?php echo $res->sponsor_id;?>">
              </div>
            </div>
          </div>
            ...
            <div class="rows">
              <div class="col-md-5">
                ...
                <div class="col-lg-8">
                  ...
                  type="text" value="<?php echo $res->sponsName1;?>">
                </div>
              </div>
              ...
              <div class="col-md-5">
                ...
                <div class="col-lg-8">
                  ...
                  type="text" value="<?php echo $res->sponsOrigin1;?>">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="rows">
              <div class="col-md-5">
                ...
                <div class="col-lg-8">
                  ...
                  type="text" value="<?php echo $res->sponsName2;?>">
                </div>
              </div>
              ...
              <div class="col-md-5">
                ...
                <div class="col-lg-8">
                  ...
                  type="text" value="<?php echo $res->sponsOrigin2;?>">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="rows">
              <div class="col-md-8">
                ...
                <div class="col-lg-7">
                  ...
                  rows="3" value="<?php echo $res->s_others;?>">
</textarea> 
                </div>
              </div>
            </div>
		  ...
		  <div class="form-group">
					<div class="rows">
						<div class="col-md-8">
							<div class="col-lg-12">
								<button class="btn btn-success btn-lg" type="submit" name="submit">Save Changes</button>
							</div>
						</div>
					</div>
				</div>
